...
uses
  ...
  FMX.ScrollBox, FMX.Memo, FMX.Ani, Operands, FMX.ExtCtrls, FMX.Objects, ShellAPI;
...
begin
  Memo1.Size.Height:=form3.Height/4.7;
  Memo1.Size.Width :=form3.Width*0.91;
...
begin
  ShellExecute(0, nil, PChar('https://yasobe.ru/na/razrabotka_obrazovatelnyh_android_prilozhenii'), '', '', 1);
end;
